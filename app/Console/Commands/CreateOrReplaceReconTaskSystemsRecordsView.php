...
class CreateOrReplaceReconTaskSystemsRecordsView extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'view:CreateOrReplaceReconTaskSystemsRecordsView';
    ...
    {
        DB::statement("CREATE VIEW recon_task_systems_records AS SELECT recon_task_systems.id AS id,

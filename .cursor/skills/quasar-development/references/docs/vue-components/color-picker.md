...
There are **helpers** for QInput `rules` prop: full list. You can use these for convenience or write the string specifying your [custom needs](/vue-components/input#internal-validation).

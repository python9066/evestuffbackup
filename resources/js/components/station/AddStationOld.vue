  ...
  <div>
    ...
    >
      <template v-slot:activator="{ on, attrs }">
        <v-btn color="pink darken-2" dark v-bind="attrs" v-on="on" @click="open()">
      ...
      >
        <v-card-title class="justify-center">
          ...
          <p v-if="state == 3">Enter Details for {{ stationPull.station_name }}</p>
        </v-card-title>
        <v-card-text>
          <div
            ...
            <div v-if="state == 2">
              ...
              <div>
                ...
                <v-radio-group v-model="refType" row :rules="[rules.required]">
                  ...
                  <v-radio v-if="this.type == 1" label="Online" value="16"></v-radio>
                </v-radio-group>
              </div>
        ...
        <v-spacer></v-spacer
        ><v-card-actions>
          <v-btn class="white--text" color="teal" @click="close()"> Close </v-btn>
          <v-btn
            class="white--text"
            color="green"
            :disabled="showSubmit"
...
export default {
  ...
  computed: {
    ...
    showSubmit3() {
      if (this.type == 3) {
        if (this.refType != null && this.vaildDate == true && this.imageLink != null) {
          return false;
        } else {
          return true;
        }

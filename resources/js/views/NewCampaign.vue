    ...
    <div class="q-ma-md">
        ...
        <q-dialog v-model="showOverlay1" persistent>
            <q-card class="myRoundTop">
                ...
                <q-card-section>
                    ...
                    pressing the green "CHARACTER" button
                </q-card-section>
        ...
        <q-dialog v-model="showOverlay2" persistent>
            <q-card class="myRoundTop">
                ...
                <q-card-section>
                    Thanks for participating in this Entosis campaign. In order
                    to participate, we need you to add the characters you are
                    using to actively hack to this tool - don't worry - we don't
                    require an ESI link.
                </q-card-section>
                <q-card-section>
                    To do this, press the "CHARACTERS" button and pick
                    **Hacker** as the role for each alt.
                </q-card-section>
                <q-card-section>
                    Once you have added all of your characters, await
                    instructions from your FC. You will be assigned a specific
                    system, which is done in-game via Squads.
                </q-card-section>
                <q-card-section>
                    Check the name of your squad for the assigned system. Once
                    instructed, move to this system and prepare to hack. If in
                    doubt, ask for help.
                </q-card-section>
                <q-card-actions align="right">
                    <q-btn
...
onMounted(async () => {
    ...
    if (can("view_campaign_members")) {
        Echo.private("operationsadmin." + operationID).listen(

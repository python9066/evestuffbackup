...
Vue.component('StationGunner', require('./components/station/StationGunner.vue').default);
...
Vue.component('TowerOnlineTimer', require('./components/tower/TowerOnlineTimer.vue').default);
Vue.component('TowerRefTimer', require('./components/tower/TowerRefTimer.vue').default);
...
Vue.component('ReconSystemCheckedButton', require('./components/recon/ReconSystemCheckedButton.vue').default);

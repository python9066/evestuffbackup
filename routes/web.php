...
Route::get('/dance', 'testController@index');
Route::get('/dance2', 'testController@key');
Route::get('/dance3', 'testController@corptest');
Route::get('/dance4', 'testController@corptest2');
Route::get('/dance', 'AuthController@test');
